...
class_name_two = image_datasets['val'].classes
print("Train",class_name) # stampa le classi che si trovano nel Train
print("Val",class_name_two) # stampa le classi che si trovano nel Validation
